...
public class Tree {
	...
	// -------------------------------------------------------------
	   public void insert(int id, int grade, String name)
	      {
	      Node newNode = new Node();    // make new node
	      newNode.ID = id;           // add in the data
	      newNode.grade = grade;
	      newNode.name = name;
	...
	// -------------------------------------------------------------
	   public boolean delete(int key) // delete node with a chosen key
	      ...
	      while(current.ID != key)        // traverse the tree until you find the node
	         {
	...
	// -------------------------------------------------------------
	   public void inOrder(Node localRoot, ArrayList<Integer> arr)
	      ...
	      if(localRoot != null)
	         ...
	         arr.add(localRoot.ID);
	         inOrder(localRoot.rightChild, arr);
	         }
	      }
	// -------------------------------------------------------------
	   public void inOrderGrades(Node localRoot, ArrayList<Integer> arr)
	      {
	      if(localRoot != null)
	         {
	         inOrderGrades(localRoot.leftChild, arr);
	         arr.add(localRoot.grade);
	         inOrderGrades(localRoot.rightChild, arr);
	         }
	      }
	// -------------------------------------------------------------
	   public Node getRoot()
